        ...
        <div class="container px-12 mt-12 mb-12 mx-auto">
            ...
            <div class="flex flex-wrap w-full mb-10">
                <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
                    <p class="mb-4 text-md font-medium text-gray-900">Generate Track Request Receipt</p>
...
?>
    <meta http-equiv="refresh" content="0; url = amazeadminpanel/index.php" />
<?php
}
?>