        ...
        <div class="container px-12 mt-12 mb-12 mx-auto">
            ...
            <div class="flex flex-wrap w-full mb-10">
                <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
                    <p class="mb-4 text-md font-medium text-gray-900">Track Usage Form</p>
                    ...
                    <div class="flex flex-wrap -m-2">
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <input type="text" maxlength="200" required placeholder="Name of track user" id="nameofuser" name="nameofuser" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-yellow-500 focus:bg-white focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 font-medium ease-in-out">
                            </div>
                        </div>
...
if (isset($_POST['addentry'])) {
    ...
    $query = "INSERT INTO `amd_track_records`(`name_of_user`, `car_of_user`, `start_time`, `end_time`, `amount_paid`, `phone_number`, `address`, `registration_date`, `created_by`) 
    VALUES ('$name_of_user','$car_of_user','$start_time','$end_time','$amount_paid','$phone_number','$address', '$registration_date', '$created_by')";
