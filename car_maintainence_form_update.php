                ...
                <div class="w-[100%] mx-auto">
                    <div class="flex flex-wrap -m-2">
                        ...
                        <div class="p-2 w-full mt-10">
                            <button name="updaterecord" class=" flex mx-auto text-white bg-yellow-500 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 font-medium rounded text-lg">Update Record</button>
                        </div>
                    </div>
                </div>
            </form>
