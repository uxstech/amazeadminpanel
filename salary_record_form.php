...
if (isset($_POST['addrecord'])) {
    ...
    $query = "INSERT INTO `amd_salary_records`(`staff_name`, `salary_date`, `salary_amount`, `staff_present_days`, `staff_contact`, `staff_address`, `created_by`)
     VALUES ('$staff_name','$salary_date','$salary_amount','$staff_present_days','$staff_contact','$staff_address','$created_by')";
