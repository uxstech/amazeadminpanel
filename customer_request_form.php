...
if (isset($_POST['addrequest'])) {
    ...
    $query = "INSERT INTO `amd_customer_requests`(`customer_name`, `work_description`, `fees_paid`, `request_date`, `mobile_number`, `created_by`)
     VALUES ('$customer_name','$work_description','$fees_paid','$request_date','$mobile_number','$created_by')";
