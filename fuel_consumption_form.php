        ...
        <div class="container px-12 mt-12 mb-12 mx-auto">
            ...
            <div class="flex flex-wrap w-full mb-10">
                <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
                    <p class="mb-4 text-md font-medium text-gray-900">Fuel Consumption Form</p>
                    ...
                    <div class="flex flex-wrap -m-2">
                        ...
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                ...
                                <input type="text" maxlength="50" required placeholder="Coach Name" id="fuelfilledby" name="fuelfilledby" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-yellow-500 focus:bg-white focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 font-medium ease-in-out">
                            </div>
                        </div>
...
if (isset($_POST['addentry'])) {
    ...
    $query = "INSERT INTO `amd_fuel_consumption_records`(`car`, `fuel_type`, `filled_fuel_in_ltr_or_kg`, `amount`, `on_date`, `meter_before`, `meter_after`, `fueled_by_coach`, `created_by`)
     VALUES ('$selected_car','$fuel_type',' $fuel_filled_in_ltr_or_kg','$amount_paid','$on_date','$meter_reading_before','$meter_reading_after','$fuel_filled_by','$created_by')";
    ...
    if ($data) {
        echo "<script type='text/javascript'>Swal.fire({
                ...
                text: 'Entry has been added successfuly',
                });
