        ...
        <div class="container px-12 mt-12 mb-12 mx-auto">
            ...
            <div class="flex flex-wrap w-full mb-10">
                <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
                    <p class="mb-4 text-md font-medium text-gray-900">Update Student Information</p>
                    ...
                    <div class="flex flex-wrap -m-2">
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                ...
                                <input type="text" value="<?= $result['first_name']; ?>" maxlength="50" required placeholder="First Name" id="firstname" name="firstname" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-yellow-500 focus:bg-white focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 font-medium ease-in-out">
                            </div>
                        </div>
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                <label for="middlename" class="leading-7 text-sm font-medium text-gray-600">Middle Name</label>
                                <input type="text" value="<?= $result['middle_name']; ?>" maxlength="50" required placeholder="Middle Name" id="middlename" name="middlename" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-yellow-500 focus:bg-white focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors font-medium duration-200 ease-in-out">
                            </div>
                        </div>
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                <label for="lastname" class="leading-7 text-sm font-medium text-gray-600">Last Name</label>
                                <input type="text" value="<?= $result['last_name']; ?>" maxlength="50" required placeholder="Last Name" id="lastname" name="lastname" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-yellow-500 focus:bg-white focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors font-medium duration-200 ease-in-out">
                            </div>
                        </div>
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                <label for="phone" class="leading-7 text-sm font-medium text-gray-600">Phone Number</label>
                                <input type="number" value="<?= $result['phone_number']; ?>" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==10) return false;" required placeholder="Phone Number" id="phone" name="phone" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-yellow-500 focus:bg-white focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors font-medium duration-200 ease-in-out">
                            </div>
                        </div>
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                ...
                                <select id="gender" name="gender" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-yellow-500 focus:bg-white focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-2 px-3 leading-8 transition-colors font-medium duration-200 ease-in-out">
                                    ...
                                    <option class="font-medium" value="Male" <?php
                                                                                if ($result['gender'] == "Male") {
                                                                                    echo "selected";
                                                                                }
                                                                                ?>>Male</option>
                                    <option class="font-medium" value="Female" <?php
                                                                                if ($result['gender'] == "Female") {
                                                                                    echo "selected";
                                                                                }
                                                                                ?>>Female</option>
                                    <option class="font-medium" value="Other" <?php
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <select id="selectstatus" name="selectstatus" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-yellow-500 focus:bg-white focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-2 px-3 leading-8 transition-colors font-medium duration-200 ease-in-out">
                                    ...
                                    <option class="font-medium" value="Pending" <?php
                                                                                if ($result['status'] == "Pending") {
                                                                                    echo "selected";
                                                                                }
                                                                                ?>>Pending</option>
                                    <option class="font-medium" value="In Progress" <?php
                                                                                    if ($result['status'] == "In Progress") {
                                                                                        echo "selected";
                                                                                    }
                                                                                    ?>>In Progress</option>
                                    <option class="font-medium" value="Completed" <?php
                        ...
                        <div class="p-2 w-full">
                            <button name="update" type="submit" class=" flex mx-auto text-white bg-yellow-500 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 font-medium rounded text-lg">Update</button>
                        </div>
                    </div>
                </div>
            </form>
...
if (isset($_POST['update'])) {
    ...
    if ($data) {
        echo "<script type='text/javascript'>Swal.fire({
                ...
                text: 'Student has been updated successfuly',
                });
