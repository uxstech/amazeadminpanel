...
<head>
    ...
    <title>Driving Track Records</title>
        ...
        <div class="container px-12 mt-12 mb-12 mx-auto">
            ...
            <div class="flex flex-wrap w-full mb-10">
                <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
                    <p class="mb-4 text-md font-medium text-gray-900">Driving Track Records</p>
            ...
            <div class="flex items-center justify-end -mt-14 mb-4">
                <form action="track_records_excel.php" method="POST">
                ...
                <a href="track_form.php"><button name="addentrytrackform" class="flex mx-auto text-white bg-yellow-500 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 font-medium rounded text-sm">Add Entry</button></a>
            </div>
                        ...
                        <div class="overflow-hidden">
                            <table class="table-fixed min-w-full">
                                ...
                                <tbody>
                                    ...
                                    $result_count = mysqli_query($conn, "SELECT COUNT(*) AS total_records FROM amd_track_records");
                                    ...
                                    ?>
                                        ...
                                        <?php
                                                ...
                                                <td class="border text-sm text-gray-500 font-medium px-6 py-4 whitespace-nowrap">
                                                    <a href="track_form_update.php?id=<?php echo $row['id'] ?>" class="font-medium px-1 text-white bg-blue-300 rounded px-3 py-1 hover:underline">Edit</a>
                                                    <a href="track_pdf_generate.php?id=<?php echo $row['id'] ?>" class=" font-medium px-1 text-white bg-blue-300 rounded px-3 py-1 hover:underline">Receipt</a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
