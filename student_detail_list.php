                                    ...
                                    ?>
                                        ...
                                        <?php
                                                ...
                                                <td class="border text-sm text-gray-500 font-medium px-6 py-4 whitespace-nowrap">
                                                    ...
                                                    <a href="student_registration_pdf_generate.php?id=<?php echo $row['id'] ?>" class=" font-medium px-1 text-white bg-blue-300 rounded px-3 py-1 hover:underline">Receipt</a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
